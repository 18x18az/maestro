...
export class AllianceSelection {
  ...
  undo (meta: IMetadata) {
    ...
    const pState: IAllianceSelectionStatus = this.history.splice(this.history.length - 2, 1)[0]
    this.state = pState
